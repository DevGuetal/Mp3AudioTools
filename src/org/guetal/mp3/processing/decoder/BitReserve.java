...
final class BitReserve {
    ...
    /**
     *  Reads integer value and put it in buf. Each integer value passed 
     *  is splitted in 8 bits and each bit is put in a position of buf
     *  
     *  @parametres val   integer containing val to put in buf[]
     */

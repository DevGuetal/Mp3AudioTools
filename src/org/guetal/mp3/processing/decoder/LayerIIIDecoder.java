...
import org.guetal.mp3.processing.commons.data.Granule;
...
public final class LayerIIIDecoder {
    ...
    public final FrameData decodeFrame(final int option) {
        ...
        //ro = new float[channels][SBLIMIT][SSLIMIT];
        //ro = new float[max_gr][channels][SBLIMIT * SSLIMIT];
    ...
    public final void read_side_info(FrameData fd) {
        ...
        if (header.version() == Header.MPEG1) {
            ...
            if (channels == 1) {
                private_bits = stream.readbits(5);
            } else {
                private_bits = stream.readbits(3);
            }
...
//        System.out.println("lay iii dec -> main_data_beg: "+ si.main_data_begin );
        
//        for(ch = 0; ch < channels; ch++)
//            for(gr = 0; gr < 2; gr++){
////            System.out.println("");
////            System.out.println("lay iii dec -> ch["+ch+"].gr["+gr+"].window_switching_flag: "+ si.ch[ch].gr[gr].window_switching_flag );
////            System.out.println("lay iii dec -> ch["+ch+"].gr["+gr+"].big_values: "+ si.ch[ch].gr[gr].big_values );
////            System.out.println("lay iii dec -> ch["+ch+"].gr["+gr+"]count1table_select: "+ si.ch[ch].gr[gr].count1table_select );
////            System.out.println("lay iii dec -> ch["+ch+"].gr["+gr+"].global_gain: "+ si.ch[ch].gr[gr].global_gain );
////            System.out.println("lay iii dec -> ch["+ch+"].gr["+gr+"].part2_3_length: "+ si.ch[ch].gr[gr].part2_3_length );
////            System.out.println("lay iii dec -> ch["+ch+"].gr["+gr+"].preflag: "+ si.ch[ch].gr[gr].preflag );
////            System.out.println("lay iii dec -> ch["+ch+"].gr["+gr+"].region0_count: "+ si.ch[ch].gr[gr].region0_count );
////            System.out.println("lay iii dec -> ch["+ch+"].gr["+gr+"].region1_count: "+ si.ch[ch].gr[gr].region1_count );
////            System.out.println("lay iii dec -> ch["+ch+"].gr["+gr+"].scalefac_compress: "+ si.ch[ch].gr[gr].scalefac_compress );
////            System.out.println("lay iii dec -> ch["+ch+"].gr["+gr+"].scalefac_scale: "+ si.ch[ch].gr[gr].scalefac_scale );
////            System.out.println("lay iii dec -> ch["+ch+"].gr["+gr+"].table_select[0: "+ si.ch[ch].gr[gr].table_select[0] );
////            System.out.println("lay iii dec -> ch["+ch+"].gr["+gr+"].table_select[1: "+ si.ch[ch].gr[gr].table_select[1] );
////            System.out.println("lay iii dec -> ch["+ch+"].gr["+gr+"].table_select[2: "+ si.ch[ch].gr[gr].table_select[2] );
////            System.out.println("lay iii dec -> ch["+ch+"].gr["+gr+"].block type: "+ si.ch[ch].gr[gr].block_type );
////            System.out.println("lay iii dec -> ch["+ch+"].gr["+gr+"].mixed_block_flag: "+ si.ch[ch].gr[gr].mixed_block_flag );
//            System.out.println("lay iii dec -> ch["+ch+"].gr["+gr+"].scalefac_scale: "+ si.ch[ch].gr[gr].scalefac_scale );
////            System.out.println("lay iii dec -> ch["+ch+"].gr["+gr+"][0].subblock_gain: "+ si.ch[ch].gr[gr].subblock_gain[0] );
////            System.out.println("lay iii dec -> ch["+ch+"].gr["+gr+"][1].subblock_gain: "+ si.ch[ch].gr[gr].subblock_gain[1] );
////            System.out.println("lay iii dec -> ch["+ch+"].gr["+gr+"][2].subblock_gain: "+ si.ch[ch].gr[gr].subblock_gain[2] );
////
//            }
...
//        s = fd_q.scalefac0S[gr][ch];
        ...
        if ((gr_info.window_switching_flag != 0) && (gr_info.block_type == 2)) {
            if ((gr_info.mixed_block_flag) != 0) {
                //System.out.println("length0 A: "+length0);
                // MIXED
    ...
    private final void reorder(final int xr[],final int ch,final int gr, Channel gr_info) {
        ...
        int freq,freq3,src_line,des_line,sfb_start3,reste,quotien;
...
//                }
    ...
    private final void dequantize_sample(final int ch,final int gr, int [] l, int [][] s) {
        ...
        for (int i=0,j = 0; j < maxNonZero; j++,i++) {
            ...
            if ((gr_info.window_switching_flag != 0) && (((gr_info.block_type == 2) && (gr_info.mixed_block_flag == 0)) || ((gr_info.block_type == 2) && (gr_info.mixed_block_flag != 0) && (j >= 36)))) {
                ...
                //System.out.println("idx (long) : " +idx + " cd: " + cb + " s[t_index][cb]: " + s[t_index][cb] + " gr_info.scalefact_scale:" + gr_info.scalefac_scale);
                //System.out.println("ro[gr][ch]: " + ro[gr][ch][quotien][reste]);
            } else {
                ...
                ro[gr][ch][j] *= two_to_negative_half_pow[idx];
                //System.out.println("idx (long) : " +idx);
                //System.out.println("idx (long) : " +idx + " cd: " + cb + "l[cb]: " + l[cb] + " gr_info.scalefact_scale:" + gr_info.scalefac_scale);
                //System.out.println("ro[gr][ch]: " + ro[gr][ch][quotien][reste]);
            }
        }
    ...
    public FrameData get_frame_info(){
        return this.fd_q;
    }
    ...
    public void copy_data(FrameDataQuantized fd){
        fd.ix = this.ix;
   ...
   /*
    ...
    private static final class SideInfo {
        ...
        private final Granule[] gr= new Granule[2];
    ...
    private static final class Granule {
        ...
        private final GRInfo[] ch= new GRInfo[2];
